  ...
  var result = (0, _object.deepMerge)(_base.base, {
      ...
      size: {
        small: {
          ...
          pad: {
            ...
            // 4px
            horizontal: "".concat(baseSpacing - borderWidth * 2, "px") // 20px,

          }
        },
        medium: {
          border: {
            radius: "".concat(baseSpacing * 0.75, "px") // 18px

          },
          pad: {
            vertical: "".concat(baseSpacing / 4 - borderWidth, "px"),
            // 4px
            horizontal: "".concat(baseSpacing - borderWidth, "px") // 22px

          }
        },
        large: {
          border: {
            radius: "".concat(baseSpacing, "px") // 24px

          },
          pad: {
            vertical: "".concat(baseSpacing / 4 + borderWidth, "px"),
            // 8px
            horizontal: "".concat(baseSpacing + borderWidth * 4, "px") // 32px,
    ...
    checkBox: {
      ...
      toggle: {
        ...
        size: "".concat(baseSpacing * 2, "px") // extend: undefined,
