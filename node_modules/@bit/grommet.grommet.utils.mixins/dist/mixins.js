...
var parseMetricToNum = function parseMetricToNum(fontAsString) {
  if (fontAsString.match(/\s/) && process.env.NODE_ENV !== 'production') {
    console.warn("Invalid single measurement value: \"".concat(fontAsString, "\""));
  }
...
var breakpointStyle = function breakpointStyle(breakpoint, content) {
  return (0, _styledComponents.css)(_templateObject2(), breakpoint.value && "and (max-width: ".concat(breakpoint.value, "px)"), content);
};
